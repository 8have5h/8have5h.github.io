...
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs"; // Assuming shadcn setup via alias
import { Card, CardContent } from "@/components/ui/card"; // Assuming shadcn setup via alias
import { Badge } from "@/components/ui/badge"; // Assuming shadcn setup via alias
...
// --- Helper Components (Updated: No Image) ---
...
function ProjectCard({
  ...
  details,
  technologies,
  projectLink, // Optional link to live project/demo
  ...
  return (
    <Card className={`group bg-gray-800/50 border ${colorClasses[color]} overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 flex flex-col`}>
      <CardContent className="p-6 md:p-8 flex flex-col flex-grow"> {/* Adjusted padding & flex */}
        ...
        {(projectLink || githubLink) && (
          <div className="mt-auto pt-4 flex flex-wrap gap-4"> {/* mt-auto pushes to bottom, flex-wrap for responsiveness */}
            {githubLink && (
              <a
                href={githubLink}
                target="_blank"
...
// AchievementCard Component (No changes needed)
function AchievementCard({ title, description, icon, color = 'yellow' }): AchievementCardProps{
    const colorClasses = {
...
function BlogTabContent() {
  ...
  useEffect(() => {
    fetch('/posts/sample-post.md') // Make sure this file exists in your /public/posts/ directory
      .then(response => {
        if (!response.ok) {
      ...
      .catch(err => {
        ...
        setError("Could not load blog post. Please ensure '/posts/sample-post.md' exists in the public folder.");
        setIsLoading(false);
      });
  }, []);
  ...
  return (
    <div>
      ...
      <div className="max-w-3xl mx-auto bg-gray-800/50 border border-gray-700 rounded-lg p-6 md:p-8">
        ...
        {!isLoading && !error && (
          // IMPORTANT: Ensure you have @tailwindcss/typography installed and configured
          // Add the following classes for basic Markdown styling
        ...
        {!isLoading && !error && !postContent && (
            <p className="text-center text-gray-500">Blog post content is empty.</p>
        )}
...
// --- Main Portfolio Component (Updated) ---
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-gray-100 transition-opacity duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <header className="relative h-screen flex items-center justify-center overflow-hidden">
          ...
          {[...Array(20)].map((_, i) => (
            <div
              ...
              style={{
                ...
                opacity: Math.random() * 0.3, filter: 'blur(70px)',
                animationDuration: `${Math.random() * 10 + 10}s`, animationDelay: `${Math.random() * 5}s`
              }}
            ></div>
          ))}
        </div>
        ...
        {/* Scroll Down Button - Updated */}
        <a href="#main-content" // Links to the main content section
           className="absolute bottom-10 left-1/2 transform -translate-x-1/2 z-20 animate-bounce text-gray-400 hover:text-gray-200"
      ...
      <main id="main-content" className="container mx-auto px-4 sm:px-6 py-16">
        <Tabs defaultValue="about" className="mb-16">
           {/* Adjusted TabsTrigger height and centering */}
          ...
          {/* About Tab Content (Updated Email) */}
         <TabsContent value="about">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-8 mb-12">
                ...
                <div className="prose prose-invert max-w-none text-gray-300 prose-p:leading-relaxed prose-headings:text-gray-100 prose-strong:text-yellow-300">
                   {/* About Me Text */}
                    <p>
                    Currently, I&apos;m pursuing a dual degree (B.Tech + M.Tech) in Computer Science & Engineering at IIT Delhi. My academic journey began strong, achieving <strong className="text-yellow-400">AIR 116 in JEE Advanced</strong>, which opened the doors to this incredible institution.
                  </p>
                  <p>
                    My core fascination lies within <strong className="text-blue-400">Machine Learning</strong> and <strong className="text-purple-400">Deep Learning</strong>. I&apos;m particularly interested in understanding how these complex models work, which leads me to the field of <strong className="text-indigo-400">Mechanistic Interpretability</strong> – trying to reverse engineer neural networks to ensure AI systems are safe and aligned with human values (<strong className="text-indigo-400">AI Safety</strong>).
                  </p>
                  <p>
                    I&apos;m actively working on challenging problems like the <strong className="text-green-400">ARC-AGI challenge</strong>, exploring techniques from program synthesis to model fine-tuning. I also have a strong background in <strong className="text-yellow-400">Competitive Programming</strong> which sharpens my algorithmic thinking.
                  </p>
                  <p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-6">
                  <h3 className="text-xl font-bold mb-4 flex items-center">
                    <BrainCircuit className="mr-2 text-purple-400" /> Areas I&apos;m Excited About
                  </h3>
          ...
          {/* Projects Tab Content (No Images, Added Links) */}
          <TabsContent value="projects" className="space-y-12">
            ...
            <ProjectCard
              ...
              color="yellow"
              githubLink="https://github.com/8have5h/ARC-AGI-Task" // <-- UPDATE REPO NAME if needed
            ...
            <ProjectCard
              ...
              color="blue"
              githubLink="https://github.com/8have5h/COL333-Assignment-1" // <-- UPDATE REPO NAME if needed
            />

            {/* Project: Object-Centric Vision */}
            <ProjectCard
              ...
              color="purple"
              githubLink="https://github.com/8have5h/COL775-Assignment-2" // <-- UPDATE REPO NAME if needed
            />

            {/* Project: Smart Table QA */}
            <ProjectCard
              ...
              color="green"
               githubLink="https://github.com/8have5h/COL772-Assignment-2" // <-- UPDATE REPO NAME if needed
            />
            ...
            <ProjectCard
              ...
              color="yellow"
              githubLink="https://github.com/8have5h/COL772-Assignment-1" // <-- UPDATE REPO NAME if needed
            />

            {/* Project: BioMed Simplifier */}
            <ProjectCard
              ...
              color="red"
              githubLink="https://github.com/8have5h/COL774-Project" // <-- UPDATE REPO NAME if needed
            />
          </TabsContent>
                 ...
                 <div className="relative">
                   ...
                   <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-6">
                     <p className="mb-4 text-gray-300">
                       Excited for my upcoming Quant Research internship! I&apos;ll be diving into the world of high-frequency trading (HFT), applying my analytical and programming skills to develop and test trading strategies. Eager to learn from the team at Ebullient!
                     </p>
                ...
                <div className="relative">
                  ...
                  <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-6">
                    ...
                    <ul className="list-disc pl-5 space-y-2 text-gray-300 text-sm">
                      <li>I implemented MISRA C rules at the Preprocessor, AST, and LLVM IR levels.</li>
                      <li>I developed rules for an Equivalence Checker comparing source code and executable.</li>
          ...
          <TabsContent value="achievements">
            {/* ... Achievements content remains the same ... */}
             <h2 className="text-3xl font-bold mb-8 text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              {/* Education & Extra-Curricular Card */}
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-6">
                <h3 className="text-2xl font-bold mb-6 flex items-center">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-700/30 p-4 rounded-lg border border-gray-600/50">
                    ...
                    <p className="text-gray-300 text-sm">Completed Harvard&apos;s foundational CS course covering C, Python, web development, and security concepts (2021).</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-sm text-gray-500">
           ...
           <p className="text-xs text-gray-600 mt-2">
            Built with React, Tailwind CSS, shadcn/ui & ❤️
          </p>
        </div>
      </footer>
    </div>
